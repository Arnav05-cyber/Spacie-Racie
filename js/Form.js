class Form{
    ...
    display()
    {
        ...
        this.button.mousePressed(()=>{
            ...
            //image(player1Image, displayWidth/2 - 70,displayHeight/4 + 10,10,10);
           // this.greeting.html("Waiting for other players to join! ")
            //this.greeting.position(displayWidth/2 - 90,displayHeight/4+40);
